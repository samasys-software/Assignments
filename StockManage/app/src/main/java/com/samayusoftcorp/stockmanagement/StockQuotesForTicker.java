package com.samayusoftcorp.stockmanagement;
...
import bussinessobjects.AverageForStockQuotes;
import bussinessobjects.ListData;
...
public class StockQuotesForTicker extends AppCompatActivity {
    ...
    ListView lvDetails;
    Context context=StockQuotesForTicker.this;
...
// custom listview using arrayadapter
