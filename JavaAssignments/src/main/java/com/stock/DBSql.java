...
public class DBSql {
   ...
   public final static String FETCH_STOCKSYMBOL="select * from ramya_stock_quotes";
   ...
   public final static String FETCH_AVERAGEFORSTOCKSYMBOL="select * from ramya_mov_average where stock=?";
